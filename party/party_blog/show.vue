<template>
	<view v-if="pageLoad">
		...
		<cmform tablename="mod_party_blog" :objectid="pageData.data.id"></cmform>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			getPage: function () {
				var that = this;
				this.app.get({
					url: that.app.apiHost + "/module.php?m=party_blog&ajax=1&a=show&id=" + id,
