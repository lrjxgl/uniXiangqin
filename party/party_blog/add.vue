			...
			<view v-if="!unLogin">
				<form  @submit="formSubmit"  >
					<div class="none">
						...
						<input type="text" name="partyid" style="display:none;" :value="partyid">
					</div>
	...
	export default {
		...
		methods: {
			...
			getPage: function () {
				var that = this;
				this.app.get({
					url: that.app.apiHost + "/module.php?m=party_blog&ajax=1&a=add",
			...
			formSubmit:function(e){
				var that=this;
				that.app.post({
					url:that.app.apiHost+"/module.php?m=party_blog&a=save&ajax=1",
					data:e.detail.value,
					success:function(res){
						uni.showToast({
							title: res.message,
